###########################################################################
## Makefile generated for component 'middle'. 
## 
## Makefile     : middle.mk
## Generated on : Tue Oct 03 13:11:15 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/middle.elf
...
START_DIR                 = C:/Users/FUGAZI/Documents/MATLAB/ASMITH/test_23/flow/middle_01
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = middle_comp.rsp
CMD_FILE                  = middle.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/middle.elf
...
DEFINES_SKIPFORSIL = -DARM_MATH_CM4 -DCOMPONENT_NSPE=1 -DCOMPONENT_PSA_SRV_EMUL=1 -DCOMPONENT_PSA_SRV_IMPL=1 -DDEVICE_ANALOGIN=1 -DDEVICE_ANALOGOUT=1 -DDEVICE_CAN=1 -DDEVICE_CRC=1 -DDEVICE_FLASH=1 -DDEVICE_I2C=1 -DDEVICE_I2CSLAVE=1 -DDEVICE_I2C_ASYNCH=1 -DDEVICE_INTERRUPTIN=1 -DDEVICE_LPTICKER=1 -DDEVICE_MPU=1 -DDEVICE_PORTIN=1 -DDEVICE_PORTINOUT=1 -DDEVICE_PORTOUT=1 -DDEVICE_PWMOUT=1 -DDEVICE_RTC=1 -DDEVICE_SERIAL=1 -DDEVICE_SERIAL_ASYNCH=1 -DDEVICE_SERIAL_FC=1 -DDEVICE_SLEEP=1 -DDEVICE_SPI=1 -DDEVICE_SPISLAVE=1 -DDEVICE_SPI_ASYNCH=1 -DDEVICE_STDIO_MESSAGES=1 -DDEVICE_TRNG=1 -DDEVICE_USTICKER=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMBED_RAM1_SIZE=0x8000 -DMBED_RAM1_START=0x10000000 -DMBED_RAM_SIZE=0x18000 -DMBED_RAM_START=0x20000000 -DMBED_ROM_SIZE=0x100000 -DMBED_ROM_START=0x8000000 -DMBED_TICKLESS -DNULL=0 -DTARGET_CORTEX -DTARGET_CORTEX_M -DTARGET_FAMILY_STM32 -DTARGET_FF_ARDUINO -DTARGET_FF_MORPHO -DTARGET_LIKE_CORTEX_M4 -DTARGET_LIKE_MBED -DTARGET_M4 -DTARGET_NAME=NUCLEO_L476RG -DTARGET_NUCLEO_L476RG -DTARGET_RELEASE -DTARGET_STM32L476RG -DTARGET_STM32L476xG -DTARGET_STM32L4 -DTARGET_STM -DTOOLCHAIN_GCC -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_object -DTRANSACTION_QUEUE_SIZE_SPI=2 -DUSBHOST_OTHER -DXCP_CUSTOM_PLATFORM -DEXTRA_IDLE_STACK_REQUIRED -DMBED_SPLIT_HEAP -DDEVICE_RESET_REASON=1 -DSTM32L476xx -DUSE_FULL_LL_DRIVER -DUSE_HAL_DRIVER -D__CORTEX_M4 -D__FPU_PRESENT=1 -D__FPU_USED=1U -D__MBED__=1 -DSTACK_SIZE=64 -DRT -DMW_RTIOSTREAM_BAUDRATE="115200"
DEFINES_STANDARD = -DMODEL=middle -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/MW_I2C.cpp C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/MW_GetPeripheralObjects.cpp xcp_ext_mode.c $(START_DIR)/middle_ert_rtw/middle.c $(START_DIR)/middle_ert_rtw/middle_data.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src/xcp_frame_serial.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_serial.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/stmnucleo/registry/../STM32L476RG/src/mw_mbed_interface.cpp C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/BufferedSerial.cpp C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/armcortexmbase/scheduler/src/SysTickScheduler.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/armcortexmbase/xcp/src/sys_arch.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/xcp_platform_timer_mbed.c C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/rtiostream_serial_mbed.cpp

MAIN_SRC = $(START_DIR)/middle_ert_rtw/ert_main.c
...
OBJS = MW_I2C.o MW_GetPeripheralObjects.o xcp_ext_mode.o middle.o middle_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
%.o : $(START_DIR)/middle_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/middle_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/middle_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/middle_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/middle_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_I2C.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/MW_I2C.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_GetPeripheralObjects.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/MW_GetPeripheralObjects.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/middle_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


middle.o : $(START_DIR)/middle_ert_rtw/middle.c
	$(CC) $(CFLAGS) -o "$@" "$<"


middle_data.o : $(START_DIR)/middle_ert_rtw/middle_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
mw_mbed_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/stmnucleo/registry/../STM32L476RG/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
xcp_platform_timer_mbed.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/xcp_platform_timer_mbed.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtiostream_serial_mbed.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/mbed/src/rtiostream_serial_mbed.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
